...
```
curl -LO https://github.com/nizartuanku/ruleforge/releases/latest/download/ruleforge-free-0.1.4-linux-amd64.tar.gz
curl -LO https://github.com/nizartuanku/ruleforge/releases/latest/download/SHA256SUMS
sha256sum -c SHA256SUMS
tar xzf ruleforge-free-0.1.4-linux-amd64.tar.gz && ./ruleforge
```
